...
export class ProjectsComponent {
  ...
  projects = [
    ...
    },
    {
      ...
      technologies: ['Java', 'Spring Boot', 'JPA', 'Lombok', 'MapStruct', 'H2 Database', 'Docker'],
    ...
    },
    {
      ...
      technologies: ['Node.js', 'Express', 'JWT', 'body-parser', 'cors', 'PostgreSQL', 'SQLite', 'Docker'],
    ...
    },
    {
      ...
      technologies: ['JavaScript', 'Vite', 'HTML', 'Tailwind CSS', 'Docker'],
